...
% basicReward | groundTruthReward | groundTruthRewardFT
info.rewardFnc = @groundTruthRewardFT;
info.FT = true; % Use this with finetuning

% Change it as required if you are validating
info.outputFile = "ft-u306-l6-rms.csv";
